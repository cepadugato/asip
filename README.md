...
```
                        ...
                        │                                     │
     VLAN 10 (MGMT)     │  ┌──────────┐  ┌───────────────┐    │
     203.0.113.0/24    │  │ bastion  │  │ mcp-watchdog  │    │
                        │  │  .5      │  │ .50 (LXC)     │    │
                        │  └──────────┘  └───────────────┘    │
                        │                        │             │
    VLAN 20 (SERVICES) │  ┌──────┐ ┌──────┐ ┌──────┐       │
    203.0.113.0/24    │  │ AD   │ │ DHCP │ │Vault │ ...    │
                        │  │ .10  │ │ .11  │ │ .12  │       │
                        │  └──────┘ └──────┘ └──────┘       │
                        │                                     │
    VLAN 30 (COLLAB)   │  ┌──────────┐  ┌──────────┐       │
    203.0.113.0/24    │  │Nextcloud │  │  Mail    │       │
                        │  │  .10     │  │  .11     │       │
                        │  └──────────┘  └──────────┘       │
                        │                                     │
    VLAN 40 (CLIENTS)  │  ┌──────────────┐                  │
    203.0.113.0/24    │  │ test-client  │                  │
                        │  │  .100        │                  │
                        │  └──────────────┘                  │
                        │                                     │
    VLAN 50 (DMZ)      │  ┌───────┐  ┌────────┐            │
    203.0.113.0/24    │  │ Proxy │  │HAProxy │            │
                        │  │ .10   │  │ .20/.21│            │
                        │  └───────┘  └────────┘            │
                        │                                     │
                        │  ┌─────────────────────────────┐   │
...
- Accès SSH au réseau `192.0.2.0/24`
