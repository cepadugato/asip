...
PROXMOX_TOKEN="${PROXMOX_TOKEN:-PROXMOX_TOKEN_PLACEHOLDER}"
...
# -------------------------------------------------------------------------------------------------
echo "--- MCP Watchdog ---"
WATCHDOG_IP="${WATCHDOG_IP:-REDACTED_WATCHDOG_IP}"
...
# -------------------------------------------------------------------------------------------------
echo "--- Forgejo ---"
FORGEJO_TOKEN="${FORGEJO_TOKEN:-FORGEJO_TOKEN_PLACEHOLDER}"
